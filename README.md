...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/steep-thunder-3b67
```

A live public deployment of this template is available at [https://steep-thunder-3b67.templates.workers.dev](https://steep-thunder-3b67.templates.workers.dev)
